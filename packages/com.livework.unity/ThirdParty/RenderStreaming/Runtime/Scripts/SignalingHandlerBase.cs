...
namespace Unity.RenderStreaming
{
    ...
    {
        // LiveWork extension; optional per-handler scheduler, including paused Editor sessions.
        public Func<IEnumerator, Coroutine> coroutineStartOverride;
        ...
        {
            if (coroutineStartOverride != null) coroutineStartOverride(AddSenderCoroutine(connectionId, sender));
            else StartCoroutine(AddSenderCoroutine(connectionId, sender));
        }
