...
namespace Unity.RenderStreaming
{
    ...
    {
        // LiveWork extension: keep signaling/encoding alive while the Editor is paused.
        // Null retains the upstream MonoBehaviour coroutine behavior.
        public Func<System.Collections.IEnumerator, Coroutine> coroutineStartOverride;
        public Action<Coroutine> coroutineStopOverride;
...
#pragma warning restore 0649
            ...
            )
        {
            ...
            RenderStreamingDependencies dependencies = new RenderStreamingDependencies
            {
                ...
                startCoroutine = coroutineStartOverride ?? StartCoroutine,
                stopCoroutine = coroutineStopOverride ?? StopCoroutine,
